...
set-patch-size 8
  ...
  set gadm-dataset gis:load-dataset "gadm41_DEU_2.shp"
  set mantis-dataset gis:load-dataset "mantis_2022.shp"
  set landcover-dataset gis:load-dataset "CORINE_2018.shp"
...
; Erstellen der Gottesanbeterinnen-turtles aus den Daten der Gottesanbeterinnen shape-Datei
  ...
  export-view "mantis_spread_0.png"
